...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Beer.url'
        db.alter_column('beerdb_beer', 'url_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['beerdb.URL'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Beer.url'
        db.alter_column('beerdb_beer', 'url_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['beerdb.URL']))
    ...
    models = {
        ...
        'beerdb.beer': {
            ...
            'url': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['beerdb.URL']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Rating', fields ['name']
        db.create_unique('beerdb_rating', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Rating', fields ['name']
        db.delete_unique('beerdb_rating', ['name'])
    ...
    models = {
        ...
        'beerdb.userbeer': {
            'Meta': {'ordering': "('user', '-date_modified', '-date_added', '-id')", 'object_name': 'UserBeer'},
